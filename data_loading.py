...
class RegressionTaskData:
    ...
    def make_trainloader(
        ...
        train_data = RegressionImageFolder(
            root=str(self.image_folder_path / Path('train')), 
            image_targets=load_image_targets_from_csv(Path(self.image_folder_path) / Path('train.csv'),header=True),
    ...
    def make_testloader(
        ...
        test_data = RegressionImageFolder(
            root=str(self.image_folder_path / Path('test')), 
            image_targets=load_image_targets_from_csv(Path(self.image_folder_path) / Path('test.csv'),header=True),
