...
class CNNRegression(nn.Module):
    ...
    def __init__(self, image_size: Tuple[int, int, int] = (1, 640, 470)):
...
def train_network(device, n_epochs: int = 10, image_size: Tuple[int, int, int] = (3, 640, 470)):
    ...
    regression_task = RegressionTaskData(grayscale=True, image_folder_path="C:/Users/Mike/Documents/imgAnalysis/recordings/US_frames/US_version4")#, resize_size=resize_size)
...
if __name__ == '__main__':
    ...
    num_epochs = 50
    #dont forget
    filename = 'C:/Users/Mike/Documents/imgAnalysis/models/oneDtutorial.pth'
    image_size: Tuple[int, int, int] = (1, 640, 470)
